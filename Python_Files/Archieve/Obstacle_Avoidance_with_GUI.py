...
if __name__ == "__main__":
    ...
    # ============================================================
    # ADVERSARIAL FAILURE SUITE
    # ============================================================
    #
    # Purpose:
    #   Stress the existing planner without modifying the algorithm.
    #
    # Tests:
    #   1. 2D/3D goal inconsistency
    #   2. High-speed crossing
    #   3. Discrete-time position swap
    #   4. Localized-PBD boundary interaction
    #   5. Large PBD displacement
    #   6. Multiple simultaneous conflicts
    #   7. Same-position initialization
    #   8. Vehicle initially inside obstacle
    #   9. Goal inside obstacle
    #   10. Obstacle-boundary grazing
    #   11. Delayed vehicle injection
    #   12. Dense multi-agent traffic
    #
    # ============================================================

    sim = Simulation(
        astar_frame_size=25.0,
        allow_3d=False,
        localized_pbd=False
    )
    ...
    # ============================================================
    # TEST 1
    # 2D / 3D GOAL INCONSISTENCY
    #
    # allow_3d=False
    #
    # These vehicles have different start/end altitudes.
    # A* will flatten the goal altitude to the start altitude,
    # while the final goal test still uses the real 3D goal.
    # ============================================================
    ...
    # HIGH-SPEED CROSSING
    #
    # Vehicles can travel 50m per simulation step.
    # ============================================================
    ...
    # ============================================================
    # TEST 3
    # EXTREME POSITION-SWAP CASE
    #
    # Two vehicles can potentially traverse each other's
    # entire starting separation in one timestep.
    # ============================================================
    ...
    # ============================================================
    # TEST 4
    # LOCALIZED-PBD BOUNDARY CHAIN
    #
    # Vehicles are placed approximately at the A* frame boundary.
    # ============================================================
    ...
    # ============================================================
    # TEST 5
    # LARGE PBD DISPLACEMENT
    #
    # Several vehicles begin heavily compressed.
    # PBD can apply substantial position corrections.
    # ============================================================
    ...
    # ============================================================
    # TEST 6
    # SAME-POSITION INITIALIZATION
    #
    # Forces dist == 0 branch inside PBD.
    # ============================================================
    ...
    # ============================================================
    # TEST 7
    # VEHICLE STARTING INSIDE OBSTACLE
    #
    # Center obstacle is at (50,50), radius=20.
    # Vehicle starts at its center.
    # ============================================================
    ...
    #
    # Goal is deliberately located inside the central cylinder.
    # ============================================================
    ...
    # ============================================================
    # TEST 9
    # OBSTACLE-BOUNDARY GRAZING
    #
    # Central obstacle:
    #     center = (50,50)
    #     radius = 20
    #
    # Vehicle center path is approximately at radius+margin.
    # ============================================================
    ...
    # ============================================================
    # TEST 10
    # MASS / MOMENTUM EXTREME
    #
    # One vehicle has effectively dominant momentum.
    # Tests weighted PBD and deflection behavior.
    # ============================================================
    ...
    # DELAYED INJECTION
    #
    # Vehicles enter an already populated traffic field.
    # ============================================================
    ...
    # ============================================================
    # TEST 12
    # FOUR-WAY SIMULTANEOUS INTERSECTION
    # ============================================================
    ...
    # ============================================================
    # TEST 14
    # LOW / HIGH ALTITUDE TRAFFIC
    #
    # allow_3d=False means these vehicles are still subject to
    # 2D planning even though they occupy different altitudes.
    # ============================================================
    ...
    # ============================================================
    # TEST 15
    # STACKED STARTING CONFLICT
    #
    # Four vehicles begin at exactly the same point and immediately
    # attempt to move in different directions.
    # ============================================================
    ...
    print("\n")
    print("=" * 80)
    print("              ADVERSARIAL FAILURE TEST")
    print("=" * 80)
    print(f"Vehicles             : {len(sim.vehicles)}")
    print(f"Obstacles            : {len(sim.obstacles)}")
    print(f"A* Frame Size        : {sim.astar_frame_size}m")
    print(f"A* 3D                : {sim.allow_3d}")
    print(f"Localized PBD        : {sim.localized_pbd}")
    print(f"Simulation dt        : {sim.dt}s")
    print("=" * 80)
